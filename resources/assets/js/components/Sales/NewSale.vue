				...
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button href="#" :disabled="cartValue === 0" class="col-lg-1 btn btn-success form-control"
							...
							Pago</button>
						<button :disabled="cartValue === 0 || newDescuento.contar_descuentos === 0" v-on:click="aplicarDescuento"
...
export default {
	...
	computed: {
		...mapState(['productForm', 'cartValue', 'cartTotal', 'formapago', 'aplicardescuento', 'newDescuento','cart']),
	},
	methods: {
