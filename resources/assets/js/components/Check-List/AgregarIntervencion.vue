        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" v-on:click="crearIntervencion({ id: intervencionForm.id_categoria})">
                        Guardar
                    </button>
...
export default {
    ...
    methods:{
        ...mapActions(['agregarIntervencion', 'cerrarIntervencion', 'crearIntervencion', 'eliminarIntervencion'])
    },
}
</script>
